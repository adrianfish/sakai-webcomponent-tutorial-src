...
public class TodoListWebAppConfiguration implements WebApplicationInitializer {

    @Override
    public void onStartup(ServletContext servletContext) throws ServletException {
        AnnotationConfigWebApplicationContext rootContext = new AnnotationConfigWebApplicationContext();
        rootContext.setServletContext(servletContext);
        rootContext.register(TodoListWebMvcConfiguration.class);
        ...
        ServletRegistration.Dynamic servlet = servletContext.addServlet("sakai.todolist", new DispatcherServlet(rootContext));
        servlet.addMapping("/");
